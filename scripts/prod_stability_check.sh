...
TMP_DIR="${TMPDIR:-/tmp}/aurelia-prod-stability"
...
import json
items = [
  {"question": "What is Aurelia AI autoresearch?", "answer": "A production stability validation run."},
...
print(json.dumps({
  ...
  "message": "Please answer briefly: what is Aurelia AI autoresearch?"
}))
PY
)
