...
async def test_playground_chat_uses_kb_context_after_indexing():
    ...
    mock_agent.system_prompt = "You are Aurelia assistant."
    ...
    chat_request = ChatRequest(
        ...
        message="What is the AureliaPlaygroundTestPhrase?",
        session_id=None,
        params={},
    )
            ...
            with patch("api.v1.endpoints.get_or_create_chat_session") as mock_session_fn:
                ...
                with patch("api.v1.endpoints.KbRetrievalService") as mock_kb_svc_cls:
                    ...
                    mock_kb_svc.retrieve = AsyncMock(return_value=[
                        {
                            "text": "The AureliaPlaygroundTestPhrase is 'knowledge-verified-2024' and proves KB retrieval works.",
                    ...
                    assert "AureliaPlaygroundTestPhrase" in system_content
