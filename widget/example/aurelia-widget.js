var AureliaWidget = (() => {
  ...
  var AureliaWidget_exports = {};
  __export(AureliaWidget_exports, {
    default: () => AureliaWidget_default
  });
  var AureliaWidget = class {
    ...
    init() {
      if (document.getElementById("aurelia-widget-container")) {
        console.warn("Aurelia Widget already initialized");
        return;
      }
      this.createStyles();
    ...
    createChatWindow() {
      ...
      <div class="aurelia-header">
        <div class="aurelia-header-title">
          ${this.config.logoUrl ? `<img src="${this.config.logoUrl}" class="aurelia-header-logo" alt="">` : ""}
      ...
      <div class="aurelia-input-area">
        <input type="text" class="aurelia-input" placeholder="\u8F93\u5165\u60A8\u7684\u95EE\u9898...">
    ...
    addMessage(message) {
      ...
      if (message.sources && message.sources.length > 0) {
        ...
        sourcesDiv.className = "aurelia-sources";
        const safeSources = message.sources.map((source) => {
          ...
          return source.type === "url"
            ? `<div class="aurelia-source-item">\u{1F4C4} <a href="${safeUrl}" target="_blank" rel="noopener">${safeTitle}</a></div>`
            : `<div class="aurelia-source-item">\u2753 ${safeQuestion}</div>`;
        }).join("");
    ...
    async sendMessage(message) {
      ...
      try {
        ...
        this.hideLoading();
        console.error("Aurelia Widget error:", error);
  ...
  var AureliaWidget_default = AureliaWidget;
  return __toCommonJS(AureliaWidget_exports);
})();
